...
/**
 * Application-scoped bridge between service broadcasts and the main screen.
 * The receiver must outlive Activity/ViewModel instances so lifecycle recreation
 * cannot lose service events.
 */
class MainServiceRepository private constructor(
    ...
    companion object {
        ...
        fun get(app: AngApplication): MainServiceRepository =
            instance ?: synchronized(this) {
                instance ?: MainServiceRepository(app.applicationContext as AngApplication).also {
                    instance = it
                }
            }
    }
