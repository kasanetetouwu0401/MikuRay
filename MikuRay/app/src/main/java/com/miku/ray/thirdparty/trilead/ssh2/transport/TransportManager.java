...
import com.miku.ray.thirdparty.trilead.ssh2.ConnectionMonitor;
import com.miku.ray.thirdparty.trilead.ssh2.DHGexParameters;
import com.miku.ray.thirdparty.trilead.ssh2.HTTPProxyData;
import com.miku.ray.thirdparty.trilead.ssh2.HTTPProxyException;
import com.miku.ray.thirdparty.trilead.ssh2.ProxyData;
import com.miku.ray.thirdparty.trilead.ssh2.NekoProxyData;
import com.miku.ray.thirdparty.trilead.ssh2.NekoSocketFactory;
import com.miku.ray.thirdparty.trilead.ssh2.ServerHostKeyVerifier;
import com.miku.ray.thirdparty.trilead.ssh2.crypto.Base64;
...
import com.miku.ray.thirdparty.trilead.ssh2.packets.PacketDisconnect;
...
import com.miku.ray.thirdparty.trilead.ssh2.util.Tokenizer;
...
public class TransportManager
{
	...
	private void establishConnection(ProxyData proxyData, int connectTimeout, int readTimeout) throws IOException
	{
		...
		if (proxyData instanceof NekoProxyData)
		{
			NekoProxyData npd = (NekoProxyData) proxyData;
			sock = NekoSocketFactory.open(npd, hostname, port);
			return;
		}
