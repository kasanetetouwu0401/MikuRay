package com.v2ray.ang.blur3.drawable;

import static com.v2ray.ang.blur3.Blur3Compat.dpf2;
import static com.v2ray.ang.blur3.Blur3Compat.multAlpha;
...
import com.v2ray.ang.blur3.Blur3HashImpl;
import com.v2ray.ang.blur3.drawable.color.BlurredBackgroundColorProvider;
import com.v2ray.ang.blur3.drawable.color.BlurredBackgroundProvider;
import com.v2ray.ang.blur3.source.BlurredBackgroundSource;
import com.v2ray.ang.blur3.source.BlurredBackgroundSourceRenderNode;
import com.v2ray.ang.blur3.utils.NinePatchBuilder;
...
public abstract class BlurredBackgroundDrawable extends Drawable {
    ...
    protected void drawSource(Canvas canvas, BlurredBackgroundSource source) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && source instanceof BlurredBackgroundSourceRenderNode) {
    ...
    private void drawSourceAny(Canvas canvas, BlurredBackgroundSource source) {
        ...
        final int backgroundColor = multAlpha(this.backgroundColor, alpha / 255f);
        if (Color.alpha(shadowColor) > 0 && alpha == 255 && shadowAlpha > 0) {
            shadowPaint.setShadowLayer(shadowLayerRadius, shadowLayerDx, shadowLayerDy, multAlpha(shadowColor, shadowAlpha));
    ...
    private void drawStrokeInternalIfNeeded(Canvas canvas) {
        final int strokeColorTop = multAlpha(this.strokeColorTop, alpha / 255f);
        final int strokeColorBottom = multAlpha(this.strokeColorBottom, alpha / 255f);
