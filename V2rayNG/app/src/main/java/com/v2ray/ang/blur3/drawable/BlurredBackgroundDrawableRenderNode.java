...
import static com.v2ray.ang.blur3.Blur3Compat.dp;
...
import com.v2ray.ang.blur3.LiquidGlassEffect;
...
public class BlurredBackgroundDrawableRenderNode extends BlurredBackgroundDrawable {
    ...
    public void setLiquidGlassEffectAllowed(Context context) {
        liquidGlassEffect = new LiquidGlassEffect(context, renderNodeFill);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        int color = multAlpha(shadowColor, renderNode.getAlpha() * shadowAlpha);
